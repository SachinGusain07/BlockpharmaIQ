...
const SupplierSettings = () => {
  ...
  const SupplierDetails = user?.vendorOrganizations?.[0] ?? null
          ...
          <div className="rounded-xl border border-gray-100 bg-white p-6 shadow-sm">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="mt-1 flex items-center rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm font-medium text-gray-700">
                  <span>{SupplierDetails.businessName}</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <div className="mt-1 flex items-center rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm font-medium text-gray-700">
                    <PhoneIcon className="mr-2 h-4 w-4" />
                    <span>{SupplierDetails.phoneNumber}</span>
                  </div>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700">Email</label>
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <div className="mt-1 flex items-center rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm font-medium text-gray-700">
                    ...
                    <span>{SupplierDetails.gstin}</span>
                  </div>
                </div>
              </div>
            </div>
